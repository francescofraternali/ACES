...
def plotting(Time_hist_1, Volt_hist_1, Perf_hist_1, PIR_hist_1, Light_hist_1, file_1, Time_hist_2, Volt_hist_2, Perf_hist_2, PIR_hist_2, Light_hist_2, file, fignum, show):
    ...
    plt.subplot(4, 1, 1)
    plt.title(file_1 + '  ' + file, fontsize=20)
    plt.grid(True)
    plt.plot(Time_hist_1, Volt_hist_1, 'r*-', label = 'Super Capacitor Voltage', markersize = 10)
    ...
    plt.subplot(4, 1, 2)
    plt.grid(True)
    plt.plot(Time_hist_1, Light_hist_1, 'b*-', label = 'Light', markersize = 10)
    #plt.plot(Time_hist_2, Light_hist_2, 'k.', label = 'Light Red', markersize = 10)
    plt.ylabel('Light\n[lux]', fontsize=15)
    plt.legend(loc=9, prop={'size': 10})
    plt.subplot(4, 1, 3)
    plt.grid(True)
    plt.plot(Time_hist_1, PIR_hist_1, 'y*-', label = 'PIR', markersize = 10)
    ...
    plt.subplot(4, 1, 4)
    plt.grid(True)
    plt.plot(Time_hist_1, Perf_hist_1, 'g*-', label = 'Action', markersize = 10)
